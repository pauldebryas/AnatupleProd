...
class HNLAnalysis_ttt(processor.ProcessorABC):
    ...
    def analyse_ttt(self, events, out, ds, mode):
        ...
        events_ttt, Sel_Tau1, Sel_Tau2 = self.select_lep_DoubleMediumChargedIsoPFTauHPS35_Trk1_eta2p1_Reg(events_ttt, min_dr_cut=0.5, min_pt_cut=40.)
        ...
        # Save histograms
        self.saved_leading_tau(events_ttt, Sel_Tau1, out, ds)
        self.saved_subleading_tau(events_ttt, Sel_Tau2, out, ds)
        self.saved_subsubleading_tau(events_ttt, Sel_Tau3, out, ds)
        self.saved_MET(events_ttt, out, ds)
        self.saved_drl1l2(events_ttt, Sel_Tau1, Sel_Tau2, out, ds)
