...
from CoffeaAnalysis.HNLAnalysis.correction_helpers import compute_sf_e, compute_sf_tau, get_trigger_correction_tau, compute_sf_L1PreFiring, get_pileup_correction, get_BTag_sf
...
class HNLAnalysis_tte(processor.ProcessorABC, HNLProcessor):
    ...
    def compute_corrections_tte(self, events, Sel_Electron, Sel_Tau1, Sel_Tau2):
        ...
        events['genWeight'] = events.genWeight * sf_tau1 * sf_tau2 * sf_e * Trigger_eff_corr_tau1 * Trigger_eff_corr_tau2 * sf_L1PreFiring * PU_corr * BTag_sf
        return events
