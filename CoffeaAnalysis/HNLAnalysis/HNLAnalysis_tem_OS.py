...
class HNLAnalysis_tem_OS(processor.ProcessorABC):
    ...
    def analyse_tem_OS(self, events, out, ds, mode):
       ...
       #computing corrections
        ...
        # Save histograms
        self.saved_leading_muon(events_tem_OS, Sel_Muon, out, ds)
        self.saved_leading_tau(events_tem_OS, Sel_Tau, out, ds)
        self.saved_leading_electron(events_tem_OS, Sel_Electron, out, ds)
        self.saved_MET(events_tem_OS, out, ds)
        self.saved_dilepton_mass(events_tem_OS, Sel_Electron, Sel_Muon, out, ds)
        self.saved_drl1l2(events_tem_OS, Sel_Muon, Sel_Electron, out, ds)
