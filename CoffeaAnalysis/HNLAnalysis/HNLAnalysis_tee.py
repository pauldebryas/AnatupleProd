...
class HNLAnalysis_tee(processor.ProcessorABC):
    ...
    def analyse_tee(self, events, out, ds, mode):
       ...
       #computing corrections
        ...
        # Save histograms
        self.saved_leading_electron(events_tee, Sel_Electron, out, ds)
        self.saved_subleading_electron(events_tee, Sel_Electron2, out, ds)
        self.saved_leading_tau(events_tee, Sel_Tau, out, ds)
        self.saved_dilepton_mass(events_tee, Sel_Electron, Sel_Electron2, out, ds)
        self.saved_MET(events_tee, out, ds)
        self.saved_drl1l2(events_tee, Sel_Electron, Sel_Electron2, out, ds)
