...
class HNLAnalysis_tem_SS(processor.ProcessorABC):
    ...
    def analyse_tem_SS(self, events, out, ds, mode):
        ...
        # Save histograms
        self.saved_leading_muon(events_tem_SS, Sel_Muon, out, ds)
        self.saved_leading_tau(events_tem_SS, Sel_Tau, out, ds)
        self.saved_leading_electron(events_tem_SS, Sel_Electron, out, ds)
        self.saved_MET(events_tem_SS, out, ds)
        self.saved_dilepton_mass(events_tem_SS, Sel_Tau, Sel_Electron, out, ds)
        self.saved_drl1l2(events_tem_SS, Sel_Muon, Sel_Electron, out, ds)
